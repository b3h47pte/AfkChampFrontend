...
func HandleAdminUserIndexPageRoute(w http.ResponseWriter, r *http.Request) {
	...
	t := CreateBaseUserAdminTemplateData(w, r)
	t.Users = allUsers
...
func CreateBaseUserAdminTemplateData(w http.ResponseWriter, r *http.Request) *AdminUserTemplateData {
	t := AdminUserTemplateData{Data: controller.CreateTemplateData(w, r),
