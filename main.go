...
func main() {
  ...
  r.HandleFunc("/admin/game",admin.HandleAdminGamePageRoute)
  r.HandleFunc("/admin/game/new",admin.HandleAdminGameNewRoute)
  r.HandleFunc("/admin/game/{gameName}",admin.HandleAdminGameEditRoute)
  r.HandleFunc("/admin/user",admin.HandleAdminUserPageRoute)
  r.HandleFunc("/admin/user/{username}",admin.HandleAdminUserRoute)
